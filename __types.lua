...
---@class pd_arc
---@field init fun(self: pd_arc, x: number, y: number, radius: number, startAngle: number, endAngle: number, direction?: boolean)
...
---@field init fun(self: pd_lineSegment, x1: number, y1: number, x2: number, y2: number)
...
---@class pd_point
---@field init fun(self: pd_point, x: number, y: number)
...
---@class pd_rect
---@field init fun(self: pd_rect, x: number, y: number, width: number, height: number)
...
---@class pd_size
---@field init fun(self: pd_size, width: number, height: number)
...
---@class pd_vector2D
---@field init fun(self: pd_vector2D, x: number, y: number)
...
---@class pd_nineSlice
---@field init fun(self: pd_nineSlice, imagePath: string, innerX: number, innerY: number, innerWidth: number, innerHeight: number)
...
---@class pd_tilemap
---@field init fun(self: pd_tilemap)
...
---@class pd_sprite
---@field init fun(self: pd_sprite, image_or_tilemap?: pd_image|pd_tilemap)
...
---@class pd_font
---@field init fun(self: pd_font, path: string)
...
---@class pd_video
---@field init fun(self: pd_video, path: string)
...
---@class pd_graph
---@field init fun(self: pd_graph, nodeCount?: number, coordinates?: table<1|2, number>[])
...
---@class pd_channel
---@field init fun(self: pd_channel)
...
---@field init fun(self: pd_lfo, type?: pd_lfo_type)
...
---@field init fun(self: pd_envelope, attack?: number, decay?: number, sustain?: number, release?: number)
...
---@class pd_bitcrusher
---@field init fun(self: pd_bitcrusher)
...
---@class pd_ringmod
---@field init fun(self: pd_ringmod)
--- Sets the wet/dry mix for the effect. A level of 1 (full wet) replaces the input with the effect output; 0 leaves the effect out of the mix.
...
---@field init fun(self: pd_onepolefilter)
--- Sets the wet/dry mix for the effect. A level of 1 (full wet) replaces the input with the effect output; 0 leaves the effect out of the mix.
...
---@field init fun(self: pd_twopolefilter, type: pd_sound_filter)
--- Sets the wet/dry mix for the effect. A level of 1 (full wet) replaces the input with the effect output; 0 leaves the effect out of the mix.
...
---@class pd_overdrive
---@field init fun(self: pd_overdrive)
--- Sets the wet/dry mix for the effect. A level of 1 (full wet) replaces the input with the effect output; 0 leaves the effect out of the mix.
...
---@class pd_delayline
---@field init fun(self: pd_delayline, length: number)
...
---@class pd_sequence
---@field init fun(self: pd_sequence, midi_path?: string)
...
---@class pd_instrument
---@field init fun(self: pd_instrument, synth?: pd_synth)
...
---@field init fun(self: pd_controlsignal)
...
---@class pd_gridview
---@field init fun(self: pd_gridview, cellWidth: number, cellHeight: number)
...
---@class pd_loop
---@field init fun(self: pd_loop, delay?: number, imageTable?: pd_imagetable, shouldLoop?: boolean)
...
---@class pd_blinker
---@field init fun(self: pd_blinker, onDuration?: number, offDuration?: number, loop?: boolean, cycles?: integer, default?: boolean)
...
--- Intermediate class definition object returned by `class()`. After creating the class with `class()`, `extends` should be called.
--- @class pd_cls_definition
--- @field extends fun(super: any) Define the base class and finalize class creation.

--- Create a new class definition.
--- @param name string Name of the new class.
--- @param properties table<any, any>? Default instance properties.
--- @param namespace string? Namespace the new class is defined in; if omitted it will be defined as a global.
--- @return pd_cls_definition cls Class definition. Be sure to call `extends` on the definition.
function class(name, properties, namespace) end

--- @class pd_object
--- @field className string Name of the tables class
--- @field isa fun(cls: any): boolean Check if this table is an instance of `cls`
--- @field tableDump fun(indent: integer?, table: any?) Print all key/value pairs to the console
Object = Object
...
--- Returns a single-line stack trace as a string. Use `print(where())` to see this trace written to the console.
--- @return string stacktrace
function where() end

--- Sample code performance.
--- @param name string Sample name.
--- @param fn fun() Wrapper function, run your sample code in here.
function sample(name, fn) end
